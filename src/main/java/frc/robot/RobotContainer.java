...
import frc.robot.commands.wrist.WristButtonControl;
...
import frc.robot.commands.autonomous.DropCubeAndMove;
import frc.robot.commands.autonomous.SwerveAuto;
...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    new JoystickButton(m_operatorController, Button.kA.value)
        .whileTrue(new WristButtonControl(-1));
  ...
  public Command getAutonomousCommand() {
    return new SwerveAuto();
//     return new DropCubeAndMove();
  }

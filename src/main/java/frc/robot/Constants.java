...
public final class Constants {
  ...
  public static final class ManipulatorConstants {
    ...
    public static final double kArmMotorRotationsPerRevolution = 256; // TODO: Verify this number
    ...
    public static final double kWristDeadband = 0.1;
    public static final double kWristIncrement = 20;
